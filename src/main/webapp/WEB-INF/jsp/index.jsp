...
<body style="margin: 0;">
    <!-- 1. 顶部海报 -->
    <div
        style="background-color: #F8F8F8; width: 100%; height: 30px; margin-bottom: 35px; margin-top: 0px">
        <span
        ...
        <span
            style="font-size: 12px; float: right; margin-top: 4px; margin-right: 10px"
